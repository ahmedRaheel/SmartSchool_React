...
type Context={getRecords:(key:string)=>ModuleRecord[];createRecord:(key:string,r:ModuleRecord)=>void;updateRecord:(key:string,r:ModuleRecord)=>void;deleteRecord:(key:string,id:string)=>void};
...
export function useMockData(){const c=useContext(C);if(!c)throw new Error("MockDataProvider required");return c}
