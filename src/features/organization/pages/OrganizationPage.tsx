...
const emptyCampus = { schoolId: "", name: "", branchType: "REGIONAL_BRANCH" as const, branchGenderTypeId: "", academicSystemId: "", address: "", city: "", province: "", country: "", phone: "", fax: "", mobile: "", email: "", logoUrl: "" };
...
export function OrganizationPage() {
  ...
  async function load(): Promise<void> {
    ...
    setLoading(true);
    try {
      const [schoolRows, campusRows, genderRows, academicSystemRows] = await Promise.all([
      ...
      setAcademicSystems(academicSystemRows);
