        ...
        <div className="modal-backdrop" onClick={event => event.target === event.currentTarget && setPaymentModal(false)}>
          <div className="modal-card" style={{ width: "min(620px,96vw)" }}>
            ...
            <div className="human-form"><div className="human-form-grid">
              ...
              {selectedInvoice && <div className="field-wide" style={{ padding: "12px 14px", borderRadius: 10, background: "var(--surface-2)", border: "1px solid var(--line)", fontSize: 12 }}>Current outstanding: <b>{pkr(selectedInvoice.balanceAmount)}</b></div>}
            </div></div>
