    ...
    <main className="login-page">
      <section className="login-showcase">
        ...
        <div className="login-copy">
          <span className="eyebrow light"><Sparkles size={15} /> Intelligent school operations</span>
          ...
          <div className="login-benefits">
            <div><BrainCircuit /><span><b>AI-powered insights</b><small>Predictions, tutoring and smart workflows</small></span></div>
            <div><BarChart3 /><span><b>Real-time visibility</b><small>Actionable dashboards across every module</small></span></div>
            <div><ShieldCheck /><span><b>Role-aware access</b><small>Built for administrators, teachers, parents and students</small></span></div>
          </div>
        </div>
      ...
      <section className="login-panel">
        <form className="login-card" onSubmit={handleSubmit}>
          ...
          <span className="eyebrow"><CheckCircle2 size={14} /> Secure portal</span>
          <h2>Welcome back</h2>
          ...
          <div className="login-options">
            <label className="check-row"><input type="checkbox" defaultChecked /> Keep me signed in</label>
