...
export const navigationSections: readonly NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/academic-setup", label: "Academic years, classes & sections", icon: BookOpen, roles: administrationRoles },
      { path: "/teachers", label: "Teachers & workload", icon: Users, roles: administrationRoles },
      { path: "/academics", label: "Classes, courses & timetable", icon: BookOpen, roles: academicRoles },
