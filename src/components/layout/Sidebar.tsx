    ...
    <>
      ...
      <aside className={`sidebar ${open ? "open" : ""}`}>
        <div className="sidebar-head">
          <div className="brand"><span className="brand-mark"><GraduationCap size={22} /></span><span>Smart<b>School</b></span></div>
          <button className="sidebar-close" onClick={onClose}><X size={20} /></button>
        </div>
        <div className="school-chip"><span>SS</span><div><b>SmartSchool Academy</b><small>Karachi • Main Campus</small></div></div>
        ...
        <div className="sidebar-upgrade">
          ...
          <div className="health-line"><i /> All systems operational</div>
        </div>
      </aside>
    </>
  );
